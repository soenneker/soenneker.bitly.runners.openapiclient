...
using Soenneker.Bitly.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Bitly.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Bitly:ClientGenerationUrl"] ?? "https://dev.bitly.com/v4/v4.json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c BitlyOpenApiClient -n {Constants.Library}",
